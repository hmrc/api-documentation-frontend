<p>This endpoint allows an agent user to attach evidence supporting a property link made on behalf of their client.</p>
...
<pre>
POST /my-organisation/clients/all/property-links/{propertyLinkSubmissionId}/evidence HTTP/1.1
