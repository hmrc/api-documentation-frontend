<p>This endpoint allows a user to attach evidence supporting a challenge case for a client.</p>
...
<pre>
POST /my-organisation/challenge-cases/{challengeSubmissionId}/evidence HTTP/1.1
