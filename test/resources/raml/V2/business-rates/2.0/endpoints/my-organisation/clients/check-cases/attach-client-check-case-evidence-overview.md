<p>This endpoint allows a user to attach evidence supporting a check case for a client.</p>
...
<pre>
POST /my-organisation/clients/all/check-cases/{checkSubmissionId}/evidence HTTP/1.1
